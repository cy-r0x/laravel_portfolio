<div class="custom-modal">
  <div class="modal-data d-flex flex-column">
    ...
    <div>
      ...
      <div class="my-card">
        <img src="{{ asset('assets/code-forces.svg') }}" alt="Codeforces logo" />
        <p>
          Codeforces Rating:
      ...
      <div class="my-card">
        <img src="{{ asset('assets/code-chef.svg') }}" alt="CodeChef logo" />
        <p>
          CodeChef Rating:
      ...
      <div class="my-card">
        <img src="{{ asset('assets/icpc.svg') }}" alt="ICPC logo" />
